...
import de.kolditz.common.RegExpPatterns;
 ...
 * @see InetAddress
 */
public class IPText extends AbstractControl implements IFillViewAware {
    ...
    public void createControlDecoration(int position, Composite drawComposite) {
        if (cd != null) {
            new ControlDecoration(text, position, drawComposite);
            adaptCD();
        }
    }
